...
export default function HeroSection() {
  ...
  const renderCTAs = (className: string) => (
    <div className={`cta-container ${className}`} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center', justifyContent: className.includes('mobile') ? 'center' : 'flex-start', marginTop: className.includes('mobile') ? '1.5rem' : '0' }}>
      ...
      <a href="https://github.com/ajaymedidhi" target="_blank" rel="noreferrer"
        className="cta-secondary" style={{
        display: 'inline-flex', alignItems: 'center', gap: '0.6rem',
        background: 'transparent', color: COLORS.textPrimary,
        padding: '0.85rem 2rem', borderRadius: '8px',
